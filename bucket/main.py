    ...
    emit(
        ctx,
        {
            "tables": {
                ...
                "ranking_sessions": {
                    "candidate_id": "integer primary key item reference",
                    "low": "integer binary-search lower bound",
                    "high": "integer binary-search upper bound",
                    "pivot_id": "integer nullable item reference",
                    "horizon": "nullable horizon filter",
                    "include_all": "boolean integer",
                    "randomize": "boolean integer",
                },
            },
